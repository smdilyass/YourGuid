        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="images/sahara.jpg?height=300&width=600&text=Sahara+Desert" class="card-img-top" alt="Sahara Desert">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="/images/atlas.jpg?height=300&width=600&text=Atlas+Mountains" class="card-img-top" alt="Atlas Mountains">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="images/Chefchaouen.jpg?height=300&width=600&text=Chefchaouen" class="card-img-top" alt="Chefchaouen">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="images/garden.jpg?height=300&width=600&text=Majorelle+Garden" class="card-img-top" alt="Majorelle Garden">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="images/mosque1.jpg?height=300&width=600&text=Hassan+II+Mosque" class="card-img-top" alt="Hassan II Mosque">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card info-card h-100">
                    <img src="images/ouarzazat.jpg?height=300&width=600&text=Ait+Ben+Haddou" class="card-img-top" alt="Ait Ben Haddou">
                    <div class="card-body">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/MarToS.webp?height=200&width=200&text=Essaouira" class="img-fluid rounded-start h-100 object-fit-cover" alt="Essaouira">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/fes.jpg?height=200&width=200&text=Volubilis" class="img-fluid rounded-start h-100 object-fit-cover" alt="Volubilis">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/DayToTangier.webp?height=200&width=200&text=Asilah" class="img-fluid rounded-start h-100 object-fit-cover" alt="Asilah">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/ElJadida.jpg?height=200&width=200&text=El+Jadida" class="img-fluid rounded-start h-100 object-fit-cover" alt="El Jadida">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
