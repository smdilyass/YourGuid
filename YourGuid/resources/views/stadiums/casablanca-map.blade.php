...
@section('content')
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('stadiums.casablanca') }}">Casablanca Grand Stadium</a>
                    </li>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-md-8">
                    <p class="lead">Explore the layout of the Casablanca Grand Stadium, the flagship venue for the 2030 FIFA
                        World Cup in Morocco.</p>
                    <p>This interactive map shows the stadium layout, entrances, parking areas, transportation hubs, and
                        facilities. Use the map to plan your visit and familiarize yourself with the venue before attending
                        matches.</p>
                </div>
                <div class="col-md-4">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <ul class="mb-0">
                                ...
                                <li><strong>Matches:</strong> Opening Match, Group Stage, Round of 16, Quarter-Final, Final
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="map-container">
                <img src="/placeholder.svg?height=600&width=1200&text=Casablanca+Stadium+Map" alt="Casablanca Stadium Map"
                    class="w-100 h-100 object-fit-cover">

                <!-- Map Overlay -->
                <div class="map-overlay">
                    <h5 class="fw-bold mb-2">Casablanca Grand Stadium</h5>
                    <p class="small mb-0">The crown jewel of Morocco's World Cup venues, designed to blend traditional
                        Moroccan architecture with modern engineering excellence.</p>
                </div>
            ...
            <div class="mt-4 mb-5">
                <p class="text-muted">Click on any point on the map to learn more about that location. This interactive map
                    is designed to help you navigate the stadium complex efficiently on match days.</p>
            </div>
            ...
            <div class="panorama-container">
                <img src="/placeholder.svg?height=500&width=1200&text=Casablanca+Stadium+360°+Panorama"
                    alt="Casablanca Stadium Panorama" class="w-100 h-100 object-fit-cover">
                ...
                <div class="panorama-info">
                    ...
                    <p class="small mb-0">Experience a 360° view of the Casablanca Grand Stadium from the center of the
                        pitch. Use the controls to navigate the panorama.</p>
                </div>
            </div>

            <div class="mt-4">
                <p>This panoramic view provides a preview of what spectators will experience during the 2030 FIFA World Cup.
                    The stadium's design ensures excellent sightlines from all seating areas, creating an immersive
                    atmosphere for fans.</p>
                <p>The Casablanca Grand Stadium features a partially retractable roof, state-of-the-art sound system, and
                    the largest screens in Africa to enhance the match day experience.</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul>
                            ...
                            <li><strong>Shuttle:</strong> Free shuttle services from designated points throughout Casablanca
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
